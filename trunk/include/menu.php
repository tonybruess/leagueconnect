...
<?php if(!isset($_SESSION['callsign'])){ ?>			<li><a href="http://my.bzflag.org/weblogin.php?url=<?php echo urlencode('http://' . $_SERVER['SERVER_NAME'].dirname($_SERVER['SCRIPT_NAME']).'authenticate.php');?>%3Ftoken%3D%25TOKEN%25%26username%3D%25USERNAME%25">Login</a></li><?php } ?>
